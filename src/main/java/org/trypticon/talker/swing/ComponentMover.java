...
public class ComponentMover extends MouseAdapter {
    ...
    private void setupForDragging(MouseEvent event) {
        ...
        if (destination instanceof JComponent) {
            JComponent component = (JComponent) destination;
    ...
    public void mouseDragged(MouseEvent event) {
        ...
        handleDraggedComponent(destination);
    }
    ...
    public void mouseReleased(MouseEvent event) {
        ...
        handleDroppedComponent(destination);
    ...
    protected void handleDraggedComponent(Component destination) {
    }

    protected void handleDroppedComponent(Component destination) {
    }
}